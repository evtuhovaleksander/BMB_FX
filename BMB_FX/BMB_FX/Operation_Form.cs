...
namespace BMB_FX
{
    public partial class Operation_Form : Form
    {
        ...
        {
            Operation_Form frm= new Operation_Form(SQL.ReadValueInt32("select Master_ID from operation where ID="+oper_id));
        ...
        public Operation_Form(int masterId)
        {
            ...
            {
                string query = "select o.ID,r.Client_ID,s.GroupService,o.Gap_Start,o.Gap_Stop,s.ID,o.canceled,o.Resource_ID from operation o " +
                ...
                Resource_Tbox.Text = Resource_ORM.get_res_where_id(cl.getInt32(7));
                Master_Tbox.Text = Master_ORM.get_master_where_id(Master_ID);

                Gap_Start = cl.getDateTime(3);
                Gap_Stop = cl.getDateTime(4);
                Order_TBox.Text = CurentOperation_ID.ToString();

                Client_TBox.Text =Client_ORM.get_name_where_id( cl.getInt32(1));
