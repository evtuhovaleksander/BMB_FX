...
namespace BMB_FX
{
    ...
    public class TimeLine_Gui
    {
        ...
        public TimeLine_Gui(DataGridView dgv)
        {
            this.dgv = dgv;
        }
    ...
    public class Window_Interval_ALL_Gui
    {
        ...
        public void check_selected()
        {
            ...
            Fill_Windows_All_Dgv();
            timelineGui.fill_DGV();
        }
        public void set_selected(int row)
        {
    ...
    public class Window_Interval_Specified_Gui
    {
        ...
        public void Window_Draw(int ind,TimeLine_Gui gui)
        {
