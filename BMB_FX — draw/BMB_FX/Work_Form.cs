...
namespace BMB_FX
{
    public partial class Work_Form : Form
    {
        ...
        {
            string query = "select o.ID,r.Client_ID,s.Service,o.Gap_Start,o.Gap_Stop,o.canceled from operation o " +
        ...
        {
            string query = "select o.ID,r.Client_ID,s.Service,o.Gap_Start,o.Gap_Stop,s.ID,o.canceled from operation o " +
                           "left join request r  on r.ID=o.Request_ID " +
                           "left join service s  on r.Service_ID=s.ID " +
                           "where o.ID="+oper_id;
            SQL cl = new SQL();
