...
int resouceID;
    ...
    public Window_Interval(int start, int stop, int masterId, int resourceId,DateTime day) : base(start, stop)
    {
        date = day;
        this.masterId = masterId;
        this.resourceId = resourceId;
    ...
    public class Resource
    {
        ...
        public Resource(int resourceID, DateTime day)
        {
            ...
            this.blocked_intervals = blocked;
            this.free_intervals = Interval_Overlap_Class.get_free_Resource_Intervals(this);
        }
